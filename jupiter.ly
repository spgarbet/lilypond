...
exposition_treble = \relative c'''
{
  ...
  %bes8 r r4 r r8. g16 |
  bes8 r r8. b16\pp c16 r8. r8 fes,16 g |

  % Theme two: Io, *Europa, Ganymede*
  << { \voiceOne bes'2(_\mp\< g4 f) | ees2( g4 bes) | }
       \new Voice {\voiceTwo bes,4 d ees d | bes2 r2 | } >> \oneVoice |  
  << { \voiceOne c'2(\!_\f aes4 g) | f2( aes4\> c) | }
       \new Voice {\voiceTwo c,4 ees f ees | c2 r2 | } >> \oneVoice |  
  <ees g>4(_\mp\! <des f>4 <aes ees'>2) |
...
exposition_bass = \relative c {
  ...
  % Theme three: Callisto
  % Doesn't fit. Needs a lot of rework
  % ees'8-. bes'8-. ees4  b,8-. ges'8-. b4-. |
  % bes,4-. b4-. ees2 |
  ...
  % Transition to Bb minor!
  \key ees \minor
  f4-.->\f ees4 des8\>(\sfz bes4) aes8~\! |
  aes4\mf( c4) ces4--( bes4) |
}
...
exposition_chords = \chordmode {
  ...
  % Transition Treating Bb minor as key
  bes2:m f2:dim |
  f2:dim bes2:m |
