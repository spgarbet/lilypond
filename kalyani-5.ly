...
\new PianoStaff <<
  \new Staff { \relative c' {
    ...
    % Fab 5 + tihai 
    \tuplet 3/2 {a'8.~^"X Fab Fives 5/6" a8 a16~} \tuplet 3/2 {a8 a8 g8}
      g8 a8~ \tuplet 3/2 {a8 b8 b8~}
    \tuplet 3/2 {b16 c8.~ c8} \tuplet 3/2 {b8.~ b8 a16~}
      \tuplet 3/2 {a4 g8} \tuplet 3/2 {g16 e16 f4~} 
    \tuplet 3/2 {f16 e8 e16 d32 e32 f16~} \tuplet 3/2 {f4 e8}
      \tuplet 3/2 {e8 d4~} \tuplet 3/2 {d16 c16~ c4} 
    \tuplet 3/2 {b8 d16 e16 f8} \tuplet 3/2 {r4 d8}
      \tuplet 3/2 {e16 f g8 r8} \tuplet 3/2 {r8 e8 f16 g16}

    % Chand 2+2+3
    <a a'>8^"X  Chand 7/16" <a a'> <a a'>8.-> a16~ a16 a8 a16->~ a8 g8 |
...
\new PianoStaff <<
  \new Staff { \relative c' {
    ...
    \grace {a16 c f g} a4^"X  sthāyī" g16 a c b~ b8 b \tuplet 3/2 {b16 c b} a8~
      a16 g a8~ a16 g a c b4 \grace {c16 b} a4  |

    \grace {b16 a} g8^"X" e~ e16 f e d~ d8 e8~ e g
      a4^"o" \grace {b16 a} g8 a c16 b8 b16 a g g e |

    e16^"X" f8 f16 e8^\prall b~ b16 e8 g16~ g8 a~ 
      a16^"o" c8 c16~ c c8 c16~ c c8 c16 b a8 g16 |

    a4^"X" a16 g8 e16 f8 e~ e16 d e g 
      f^"o" e d8~ d4 \grace {a'16 g16} f16 e d8 \slashedGrace f16 e8.^\prall d16 |
  ...
  \new Staff { \relative c {
    ...
    \grace {s4} \repeat percent 2  {c4^"X" <g' a> <g a> f, <f' g>^"o" <g a> <g a> f, } |
  }}
>>
...
%  \textMark "mañjhā"
  ...
  r4^"X  mañjhā" \slashedGrace {f16} e8 d e f d8. e16 
    c8^"o" b \slashedGrace {d16} c8 d~ d c~ c4 

  \slashedGrace {b16} a4^"X" c8. e16 d c d f e d c8~ 
    c8^"o" a~ a d~ d g~ g4 |

  \slashedGrace { c16 b } a4^"X" \slashedGrace f16 e8 d e f d8. e16 
    c8^"o" b \slashedGrace d16 c8 d~ d c~ c4 |

  \slashedGrace b16 a4^"X" c8. e16 d c d f e d c8~
    c8^"o" e~ e g~ g a~ a4 |

  \slashedGrace {b16 a} g4^"X" \bar "!" 
}}
...
%  \textMark "antara"
   ...
   r8.^"X  antara" d'16 c b c e d c d f e d e8~ 
    e8^"o" g~ g a~ a a~ a8. c16 |
 
   b8.^"X" c32 b a8 g~ g16 e8. g4 
    f8.^"o" g32 f e8 d~ d16 b8. d4 |

   c16^"X" d c b c b c e d8 \slashedGrace d16 e8~ e16 g8. 
    r8^"o" \slashedGrace e16 g8~ g16 a8. \slashedGrace g16 a8. c16~ c8 b~ |

   b8^"X" a16 g e8. g16 f8 e16 d b8. d16~
    d8^"o" c~ c a16 g a8. g16 g8 e |
 
  f4^"X  or" s8 e4^\prall \bar "!" 
}}
...
\new Staff { \relative c' {
  ...
  <f a c>4.^"X  Rick Roll" <g b d>8~ <g b d>4 g4 
    <g b d>4.^"o" <g c e>8~ <g c e>4  g'16 f e8 |
  <f, a c>4.^"X" <g b d>8~ <g b d>4 g4 
    r2^"o" r8 g16 g a c a c |
}}    
...
\new Staff { \relative c' {
  ...
  g'8^"X Variation Backbone" a c b b b b16 c b8 a a a a
    a^"o" g g g e e e g a g a c |
  b^"X" b c16 b d8 c c16 b a8 a a a b16 a g8 
    g8^"o" g e g e g f^\prall e d d e e | 
  e^"X" g16 e g8 e g g a a a b16 a c b a8 
    b16^"o" a g8 a g a c b^\prall a g \tuplet 2/3 {a16 g g e}
...
\new Staff { \relative c' {
  ...
  r4^"X  Laykari 4/3" g'16\ppp a c b~ b8 b \tuplet 3/2 {b16 c b} a8 
    \tuplet 3/2 {g8\mp^"o" a c} b4^\prall  \tuplet 3/2 {b4 b16 c} \tuplet 3/2 {b16 c a4~\mf } |
  \tuplet 3/2 {a8^"X" g a~} \tuplet 3/2 {a4 g8} \tuplet 3/2 { a c b~^\prall } 
    \tuplet 3/2 {b4^"o" c16 b} a4 \tuplet 3/2 {b16 a g4} \slashedGrace f16 e4^\prall \tuplet 3/2 {f8^\prall e d~} |
  \tuplet 3/2 {d4^"X" e8~} e4 \grace {e16 f} \tuplet 3/2 {g4^\prall a8~} \tuplet 3/2 {a4 b16 a} 
    \tuplet 3/2 {g4^"o" a8~} \tuplet 3/2 {a c b~} \tuplet 3/2 {b b a->} \tuplet 3/2 {g g-> e} |
   \slashedGrace e16 f4-^^"X  or" s8 e4-^^\prall \bar "!" 
