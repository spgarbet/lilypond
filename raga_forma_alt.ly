...
guitar = \relative c' {
  ...
  c4) r8 <bes f des' f>4.^\markup{Bb-} r4

  % 1st variation

  <f c' f g c>4.^\markup{\column{Fsus2 "X 1st variation"}} <f c' f g c> r4

  <f c' f g c>4. <f c' f g c> r4
  <f c' f g c>4. <f c' f g c> r4
  <bes f des' f>4.^\markup{Bb-} r8 r2


  r1^\markup{o}
  r4. <bes f des' f>4.^\markup{Bb-} r4

  <f c' f g c>4.^\markup{Fsus2}  <f c' f g c>4. r4
  <c g' bes ees g>4.^\markup{C-7} <c g' c ees a c>4.^\markup{C-6} r4
